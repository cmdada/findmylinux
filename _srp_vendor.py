"""Pure-Python SRP-6a, vendored from cocagne/pysrp (srp/_pysrp.py), BSD-3-Clause.

six removed; Python-3-only. Used for Apple GSA authentication in apple.py.
"""
...
def HNxorg( hash_class, N, g ):
    ...
    return bytes( hN[i] ^ hg[i] for i in range(0, len(hN)) )
